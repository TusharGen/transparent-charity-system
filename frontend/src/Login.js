            ...
            <div className='p-3 rounded w-25' style={{ backgroundColor: '#1C1C24' }}>
                ...
                <form action="" onSubmit={handleSubmit}>
                    <div className='mb-3'>
                        ...
                        <input type="email" style={{ backgroundColor: '#13131A', color: 'white' }} onChange={handleInput} placeholder='Enter Email' name='email' className='form-control rounded-0'></input>
                        {errors.email && <span className='text-danger'>{errors.email}</span>}
                    </div>
                    <div className='mb-3'>
                        <label style={{ color: 'white' }} htmlFor="password">Password</label>
                        <input type="password" style={{ backgroundColor: '#13131A', color: 'white' }} onChange={handleInput} placeholder='Enter Password' name='password' className='form-control rounded-0'></input>
